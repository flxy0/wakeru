...
I would personally consider anything pre-alpha quality at this point in time. The existing templates are all unstyled and -formatted, while other routes only end in a plaintext response. This will hopefully be addressed in the future™.
